...
AUTOMATION_DATA[2026] = {
  ...
  summary: 'The agentic era accelerates with GPT-5.5, Claude Opus 4.7, and DeepSeek V4. Open-weight models reach near-frontier capability at 5–25× lower cost. Enterprise agent platforms (IBM Bob, Microsoft Agent 365, Google Antigravity 2.0) go mainstream.',
  milestones: [
