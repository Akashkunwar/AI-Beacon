...
AUTOMATION_DATA[2026] = {
  ...
  summary: 'The agentic era accelerates with GPT-5.5, Claude Opus 4.7, and DeepSeek V4. Open-weight models reach near-frontier capability at 5–25× lower cost. Enterprise agent platforms (IBM Bob, Microsoft Agent 365) go mainstream.',
  milestones: [
  ...
  sectors: {
    softwareEngineering: {
      ...
      description: 'Autonomous agents build and deploy; humans set strategy.',
      keyAITools: ['GPT-5.5', 'Claude Opus 4.7', 'Claude Sonnet 4.6', 'Devin V2', 'Cursor 3', 'IBM Bob', 'Junie CLI'],
    },
    ...
    cybersecurity: {
      ...
      automationPct: 74,
      jobsAtRisk: 800_000,
      description: 'Autonomous defense and threat response.',
      keyAITools: ['GPT-5.5-Cyber', 'Claude Mythos', 'SOAR', 'Threat intel'],
    },
    research: {
      ...sectors2023.research,
      automationPct: 54,
      jobsAtRisk: 1_080_000,
      description: 'AI-driven hypothesis and experiment design.',
